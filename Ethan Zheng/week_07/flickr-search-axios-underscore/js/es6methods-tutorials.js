...
_(groucho).each( function(val, key, index ){
...
// Longer version:
// - multiple arguments (parameters) REQUIRE parantheses
...
console.log('guitarist:', guitarist);
  ...
  // objects; so instead of passing in a "search critera object" as argument, you have to give
