...
f3 = Flight.create! flight_number: 'BA1024', departure_date: '2022-03-03 11:20', origin: 'SYD', destination: 'SIN', airplane: a2
...
puts "User #1 has #{User.third.reservations.length} reservations (should be 2)"
